...
Interturkic text will be set in lowercase by default, e.g.\ \latscript{kiyiz} `felt (material)'.
However, when specifying suffixes, segments that alternate with respect to vowel harmony or consonant assimilation will be set in uppercase, e.g.\ the locative case suffix \latscript{-DA}.
By contrast, segments that are invariant to such processes will be set in lowercase, e.g.\ the genitive suffix \latscript{-nIñ}.
