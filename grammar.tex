...
\begin{document}
  ...
  \include{contents/notation}

  \mainmatter

  \part{Phonology}

  \include{contents/phonology/phonemic-inventory}
  \include{contents/phonology/phonotactics}
  \include{contents/phonology/morphophonology}
  \include{contents/phonology/non-phonemic-allophony}
